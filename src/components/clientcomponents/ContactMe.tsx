...
export default function ContactMe() {
  ...
  return (
    <section id="contactme" className="bg-yellow-300 py-20 w-full">
      ...
      <div className="md:flex justify-between items-start md:px-32 2xl:px-80">
        <div className="md:flex justify-center items-center px-4 md:px-0 md:w-5/12">
          <div className="w-full text-left">
            ...
            <h3 className="mt-0 mb-2 font-semibold text-xl md:text-xl">
              Living In:
            </h3>
            <h3 className="mt-0 mb-8 font-normal text-base md:text-lg">
        ...
        <div className="md:flex justify-center items-center mt-20 md:mt-0 px-4 md:px-0 md:w-6/12">
          <form ref={form} onSubmit={sendEmail} className="w-full">
            ...
            <button
              type="submit"
              value="submit"
              className="border-0 bg-gray-900 mt-6 px-10 py-4 font-semibold text-base text-white"
            >
              Send
            </button>
          </form>
